    ...
    <div class="mt-5 mx-auto col-11">
        ...
        <table class="mt-2 table table-striped">
            <thead>
              ...
              <tbody>
                <?php
                //kode menngambil semua data dari tabel buku
                $sql = "SELECT * FROM buku";
                $result = $koneksi->query($sql);
                //jika ada data, maka akan menggunkan perulangan while untuk penampilakan setiap baris data dalam tabel
                if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>";
                // menampilkan gambar jika ada file yang di upload
                    ...
                    echo "</td>";
                    echo "<td>";
                    // untuk menampilkan link edit dengan menyertakan parameter kode buku
