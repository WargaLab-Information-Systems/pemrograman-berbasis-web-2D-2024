...
<body>
    ...
    ?>
        ...
        <form style="margin: 10px; width: 50%;" action="../proses/update.php" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" class="form-control" id="inputCatalog" readonly name="kode_buku" value="<?php echo $row['kode_buku']?>">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="inputTahunTerbit" name="tahun_terbit" value="<?php echo $row['tahun_terbit']?>" >
            </div>
            <div class="mb-3">
                <label for="SampulBuku" class="form-label">Sampul Buku</label>
                <img src="../image/<?php echo $row['sampul_buku']; ?>" style='max-width: 100px; max-height: 100px;'>
                <input type="file" class="form-control mt-2" name="sampul_buku" id="SampulBuku">
