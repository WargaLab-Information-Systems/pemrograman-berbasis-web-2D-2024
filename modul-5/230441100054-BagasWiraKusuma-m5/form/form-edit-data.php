...
<body>
    ...
    ?>
        ...
        <form style="margin: 10px; width: 50%;" action="../proses/update.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="inputSampul" class="form-label">Sampul Buku</label>
                <input type="file" class="form-control" id="inputSampul" name="sampul">
                <input type="hidden" name="sampulLama" value="<?php echo $row['sampul'];?>">
            </div>
